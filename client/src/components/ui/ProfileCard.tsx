...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, rgba(5, 46, 22, 0.6) 0%, rgba(34, 197, 94, 0.15) 100%)';
...
export const ProfileCard: React.FC<ProfileCardProps> = React.memo(({
  ...
  return (
    <div ref={wrapRef} className={`pc-card-wrapper ${className}`.trim()} style={cardStyle}>
      ...
      <div ref={shellRef} className="pc-card-shell" onClick={onCardClick}>
        <section className="pc-card cursor-pointer">
          <div className="pc-inside">
            ...
            <div className="pc-content pc-avatar-content">
              ...
              />
              {children && <div className="pc-custom-body" style={{ pointerEvents: 'auto' }}>{children}</div>}
              {showUserInfo && (
